# Test 2 S22 NCCL-Preflight Runtime Mini-SWE Eval Readiness

Timestamp: 2026-05-21T10:56:04Z

## Task Attachment

Task id: `M1-S22-NCCL-PREFLIGHT-EVAL-READY-TEST2`

Owner: `intern_code_test_2`

Upstream runtime task: `M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2`

Scope: prepare the mini-swe eval handoff package for a future checkpoint/model or served endpoint produced by `M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2`.

Durable evidence path: `workspace/tasks/milestone1_qwen3_8b_loop/evidence/test_2_s22_nccl_preflight_eval_ready.md`
...
- dev_2 is authorized under `M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2`.
- dev_2 must run NCCL/NVLink preflight first.
- SFT may run only if that preflight passes.
- No mini-swe eval is authorized by this package.

Current eval blocker:

- No PM-gated checkpoint/model or served endpoint from `M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2` has been handed to test_2.
- Until dev_2 evidence lands and PM explicitly gates a model/endpoint for eval, mini-swe remains blocked.
- No mini-swe eval command was run for this package.

Unblock condition:

```text
PM explicitly gates a complete checkpoint/model or served endpoint from M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2 for mini-swe eval.
```
...
run_id: <nccl-preflight-sft-run-id>
...
```text
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2
```

Required generated paths:

```text
logs: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/logs
predictions: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/preds.json
results: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/results.json, if scoring runs
metrics: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/metrics_readiness.json
run metadata: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/metadata
trajectories: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/trajectories
temporary datasets/intermediates: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/tmp
HF_HOME: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/hf_home
HF_DATASETS_CACHE: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/hf_datasets_cache
UV_CACHE_DIR: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/uv_cache
APPTAINER_CACHEDIR: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/apptainer_cache
SINGULARITY_CACHEDIR: /home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/singularity_cache
```
...
export NCCL_PREFLIGHT_RUN_ID="<nccl-preflight-sft-run-id>"
...
EVAL_ROOT=/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2
...
{
  "task_id": "M1-S22-NCCL-PREFLIGHT-EVAL-READY-TEST2",
  "owner": "intern_code_test_2",
  "source_runtime_task": "M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2",
  "nccl_preflight_run_id": "$NCCL_PREFLIGHT_RUN_ID",
...
```text
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/preds.json
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/metrics_readiness.json
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/results.json, if scoring runs
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/trajectories/*.json or per-instance trajectory files
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/logs/mini_swe_stdout_stderr.log
/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/metadata/run_metadata.json
```
...
```json
{
  ...
  "eval_root": "/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2",
  "predictions_path": "/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/output/preds.json",
  "results_json_path": "<path or empty>",
  "logs_path": "/home/xu.yang/milestone1_qwen3_8b_loop/m1_s22_nccl_preflight_eval_ready_test2/logs/mini_swe_stdout_stderr.log",
  "total_instances": 2,
...
- PM-gated checkpoint/model or served endpoint from `M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2` exists.
- NCCL/NVLink preflight passed in dev_2 evidence if SFT was run.
...
- dev_2 preflight fails or prevents SFT, and no model artifact is produced.
...
Reason: eval handoff is prepared for `M1-S22-NCCL-PREFLIGHT-SFT-RUNTIME-DEV2`, but no PM-gated checkpoint/model or served endpoint has been handed to test_2. No mini-swe eval was run.
