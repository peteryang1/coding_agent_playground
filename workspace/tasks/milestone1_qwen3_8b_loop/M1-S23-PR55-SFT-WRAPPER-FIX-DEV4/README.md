...
- Cite dev_2 PR55 runtime logs and exact blocker.
- Explain why the exported LLamaFactory wrapper referenced non-exported `DEP_TARGET`.
- Patch or propose the wrapper/env strategy.
- Preserve `/home/xu.yang/coding_agent_playground/outputs` generated-artifact paths.
- Preserve no-remote-source/dependency-network local-bundle transfer rule.
